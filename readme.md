...
Over the weekend I made the decision to use _The Simpsons_ characters for my version of _Guess Who?_: this would provide strong, clear theming as well as removing a significant amout of work required for character/game art by using existing assets.        
...
![Early functionality screenshot](/images/screenshot4.png)     
...
The final day before presentation! I took the approach of 'less is more' as I did not want a repeat of the day before. The game was successfully hosted on GitHub Pages, the final changes made before presentation were additional comments for clarity, and the splitting of `main.js` into multiple JavaScript files for ease of navigation.     
